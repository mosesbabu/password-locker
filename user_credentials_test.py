...
class TestUser(unittest.TestCase):
	...
	def setUp(self):
		...
		'''
		self.new_user = User('testuser','test','123456')

	def test__init__(self):
		'''
		Test to if check the initialization/creation of user instances is properly done
		'''
		self.assertEqual(self.new_user.first_name,'testuser')
		self.assertEqual(self.new_user.last_name,'test')
...
class TestCredentials(unittest.TestCase):
	...
	def setUp(self):
		...
		'''
		self.new_credential = Credential('testuser','instagram','test','123456')

	def test__init__(self):
		'''
		Test to if check the initialization/creation of credential instances is properly done
		'''
		self.assertEqual(self.new_credential.user_name,'testuser')
	...
	def test_save_credentials(self):
		...
		twitter = Credential('John','Twitter','doe','123456')
	...
	# 	'''
	# 	self.twitter = Credential('Twitter','test','')
	...
	def test_display_credentials(self):
		...
		twitter = Credential('John','Twitter','doe','123456')
		twitter.save_credentials()
		gmail = Credential('John','Gmail','doe','mypsword')
